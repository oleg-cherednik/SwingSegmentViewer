...
import cop.swing.controls.segment.primitives.fillable.MinusSegment;
import cop.swing.controls.segment.primitives.fillable.PlusSegment;
...
//    }
    ...
    public void paint(Graphics g) {
        if (value == null)
            ...
            drawPart(g, 0x1, MINUS, (value == '-') ? 0x1 : 0x2);
            drawPart(g, 0x1, PLUS, (value == '+') ? 0x1 : 0x2);
        }
    }
}
